...
st.set_page_config(page_title="Imtiaz Analytics ", page_icon="📈", layout="wide")  

# Tital 
st.markdown("<h1 style='text-align: center; color: #fb8500;'>Save Your Data</h1>", unsafe_allow_html=True)
