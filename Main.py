...
#page behaviour
st.set_page_config(page_title="Imtiaz Analytics ", layout="wide")  
...
# Tital 
st.markdown("<h1 style='text-align: center; color: #fb8500;'>IMTIAZ ANALYTICS DASHBOARD</h1>", unsafe_allow_html=True)
...
#1. simple bar graph
 ...
 fig_investment = px.bar(
    ...
    color_discrete_sequence=["#fb8500"] * len(investment_by_businessType),
...
#2. simple line graph------------------
 ...
 fig_state = px.line(
    ...
    color_discrete_sequence=["#fb8500"] * len(investment_by_state),
    template="plotly_white",
 )
...
<div class="footer">
<p>Developed by Imtiaz <a style='display: block; text-align: center;' href="https://www.heflin.dev/" target="_blank">Samir.s.s</a></p>
</div>
"""
